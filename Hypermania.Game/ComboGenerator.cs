...
namespace Hypermania.Game
{
    ...
    public class ComboGenerator
    {
        ...
        private PlayerSimOptions _attacker;
        ...
        )
        {
            ...
            for (int i = 0; i < primaryNotes.Count; i++)
            {
                ...
                CommitMovementFallback(currentBeat, currentChannel, nextBeat, beatAfterNext, moves);
                hasPrev = false;
                prevKb = sfloat.Zero;
        ...
        private void InitializeFromCaller(SimOptions options, int attackerIndex)
        {
            ...
            _attacker = options.Players[attackerIndex];
            _noteHitHalfRange = 5;
        ...
        )
        {
            ...
            CommitNoOpBeat(nextBeat, nextChannel, beatAfterNoop, moves);
            return true;
        }
        ...
        private bool TryHit(ref GameState snapshotSource, InputFlags input, Frame windowBeat, out BoxProps hitProps)
        {
            ...
            HitboxData data = _attacker.GetHitboxData(cs);
        ...
        private sfloat GetReach(InputFlags input)
        {
            ...
            HitboxData data = _attacker.GetHitboxData(state);
