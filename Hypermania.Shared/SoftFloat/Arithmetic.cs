namespace Hypermania.Shared.SoftFloat
{
    public static partial class Mathsf
    {
        ...
        /// </summary>
        public static void Remquo(sfloat x, sfloat y, out sfloat remainder, out int quotient)
        {
            uint ux = x.RawValue;
            uint uy = y.RawValue;
            ...
            if (
                (ex == ey || (ex + 1 == ey && ((sfloat)2.0f * x > y || ((sfloat)2.0f * x == y && (q % 2) != 0))))
                && x > y
            )
            {
                x -= y;
        ...
        /// </summary>
        public static sfloat Remainder(sfloat x, sfloat y)
        {
            Remquo(x, y, out sfloat remainder, out _);
            return remainder;
        }
        ...
        /// Returns x modulo y
        /// </summary>
        public static sfloat Fmod(sfloat x, sfloat y)
        {
            uint uxi = x.RawValue;
            uint uyi = y.RawValue;
        ...
        /// </summary>
        public static sfloat Round(sfloat x)
        {
        ...
        /// </summary>
        public static sfloat Ceil(sfloat x)
        {
            uint ui = x.RawValue;
            int e = (int)(((ui >> 23) & 0xff) - (0x7f));
        ...
        /// </summary>
        public static sfloat Trunc(sfloat x)
        {
            uint i = x.RawValue;
