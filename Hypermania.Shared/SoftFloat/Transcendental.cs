namespace Hypermania.Shared.SoftFloat
{
    ...
    {
        private static sfloat Scalbn(sfloat x, int n)
        {
        ...
        /// </summary>
        public static sfloat Log2(sfloat x)
        {
            ...
            return (lo + hi) * sfloat.FromRaw(IVLN2LO_U32)
                + lo * sfloat.FromRaw(IVLN2HI_U32)
                + hi * sfloat.FromRaw(IVLN2HI_U32)
                + (sfloat)k;
        }
        ...
        public static sfloat Pow(sfloat x, sfloat y)
        {
            ...
            if (iy > 0x4d000000)
            {
                ...
                w =
                    (t * t)
                    * (sfloat.FromRaw(0x3f000000) - t * (sfloat.FromRaw(0x3eaaaaab) - t * sfloat.FromRaw(0x3e800000)));
            ...
            else
            {
                ...
                r =
                    ...
                    * s2
                    * (
                        sfloat.FromRaw(L1_U32)
                        + s2
                            * (
                                sfloat.FromRaw(L2_U32)
                                + s2
                                    * (
                                        sfloat.FromRaw(L3_U32)
                                        + s2
                                            * (
                                                sfloat.FromRaw(L4_U32)
                                                + s2 * (sfloat.FromRaw(L5_U32) + s2 * sfloat.FromRaw(L6_U32))
                                            )
                                    )
                            )
                    );
                ...
                z_l =
                    sfloat.FromRaw(CP_L_U32) * p_h
                    + p_l * sfloat.FromRaw(CP_U32)
                    + sfloat.FromRaw(k == 0 ? DP_L_0_U32 : DP_L_1_U32);
            ...
            t1 =
                ...
                - t
                    * (
                        sfloat.FromRaw(P1_U32)
                        + t
                            * (
                                sfloat.FromRaw(P2_U32)
                                + t
                                    * (
                                        sfloat.FromRaw(P3_U32)
                                        + t * (sfloat.FromRaw(P4_U32) + t * sfloat.FromRaw(P5_U32))
                                    )
                            )
                    );
