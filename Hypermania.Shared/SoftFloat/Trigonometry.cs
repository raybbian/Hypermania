namespace Hypermania.Shared.SoftFloat
{
    public static partial class Mathsf
    {
        ...
        /// </summary>
        public static sfloat Sin(sfloat x)
        {
            ...
            sfloat result =
                ((sfloat)16.0f * x * piMinusX) / (sfloat.FromRaw(pi_squared_times_five) - (sfloat)4.0f * x * piMinusX);
        ...
        /// </summary>
        public static sfloat Cos(sfloat x) => Sin(x + sfloat.FromRaw(half_pi));

        /// <summary>
        /// Returns the tangent of x
        /// </summary>
        public static sfloat Tan(sfloat x) => Sin(x) / Cos(x);

        /// <summary>
        /// Returns the square root of (x*x + y*y)
        /// </summary>
        public static sfloat Hypot(sfloat x, sfloat y)
        {
            sfloat w;
        ...
        /// </summary>
        public static unsafe sfloat Atan(sfloat x)
        {
            sfloat z;
        ...
        public static sfloat Acos(sfloat x)
        {
            ...
            {
                sfloat p =
                    z * (sfloat.FromRaw(P_S0_U32) + z * (sfloat.FromRaw(P_S1_U32) + z * sfloat.FromRaw(P_S2_U32)));
        ...
        /// </summary>
        public static sfloat asinf(sfloat x) => sfloat.FromRaw(half_pi) - Acos(x);
    }
}
